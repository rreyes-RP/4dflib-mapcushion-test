...
public class CheckInStatus extends FdfCommonServices {
    ...
    */
    ...
    public List<FdfEntity<Visit>> getVisitByUserTypeWithHistory(String typeUser) {
        List<FdfEntity<Visit>> visitByCheckStatus = getEntitiesByValueForPassedField(Visit.class, "typeUser", typeUser);
        return visitByCheckStatus;
    }

    public List<Visit> getVisitByUserType(String typeUser) {
        List<FdfEntity<Visit>> visitByCheckStatusWithHistory = getVisitByUserTypeWithHistory(typeUser);
