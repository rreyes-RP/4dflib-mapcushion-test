...
public class SK_CheckInStatus extends FdfCommonServices {
    ...
    */
    ...
    public List<FdfEntity<SK_Visit>> getVisitByUserTypeWithHistory(String typeUser) {
        List<FdfEntity<SK_Visit>> visitByUserType = getEntitiesByValueForPassedField(SK_Visit.class, "typeUser", typeUser);
        return visitByUserType;
    }

    public List<SK_Visit> getVisitByUserType(String typeUser) {
        List<FdfEntity<SK_Visit>> visitByYearWithHistory = getVisitByUserTypeWithHistory(typeUser);
        List<SK_Visit> visit = new ArrayList<>();
        for(FdfEntity<SK_Visit> visitWithHistory: visitByYearWithHistory) {
